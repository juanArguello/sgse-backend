...
public class FacturaRestController {
	...
	@PreAuthorize("hasAuthority('Registrar facturas')")
	...
	@PreAuthorize("hasAuthority('Visualizar facturas')")
	...
	@PreAuthorize("hasAuthority('Modificar facturas')")
	...
	@PreAuthorize("hasAuthority('Eliminar facturas')")
	@DeleteMapping("/{id}")
