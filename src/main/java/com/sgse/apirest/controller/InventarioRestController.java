...
public class InventarioRestController {
	...
	@PreAuthorize("hasAuthority('Registrar Inventario')")
	...
	@PreAuthorize("hasAuthority('Visualizar Inventario')")
	...
	@PreAuthorize("hasAuthority('Modificar Inventario')")
	...
	@PreAuthorize("hasAuthority('Eliminar Inventario')")
