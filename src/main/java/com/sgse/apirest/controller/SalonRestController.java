...
public class SalonRestController {
	...
	@PreAuthorize("hasAuthority('Registrar Salon')")
	...
	@PreAuthorize("hasAuthority('Visualizar Salon')")
	...
	@PreAuthorize("hasAuthority('Modificar Salon')")
	...
	@PreAuthorize("hasAuthority('Eliminar Salon')")
