...
public class SeguroRestController {
	...
	@PreAuthorize("hasAuthority('Crear seguro')")
	...
	@PreAuthorize("hasAuthority('Listar seguro')")
	...
	@PreAuthorize("hasAuthority('Actualizar seguro')")
	...
	@PreAuthorize("hasAuthority('Eliminar seguro')")
