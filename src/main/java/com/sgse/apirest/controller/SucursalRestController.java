...
public class SucursalRestController {
	...
	@PreAuthorize("hasAuthority('Registrar Sucursal')")
	...
	@PreAuthorize("hasAuthority('Visualizar Sucursal')")
	...
	@PreAuthorize("hasAuthority('Actualizar Sucursal')")
	...
	@PreAuthorize("hasAuthority('Eliminar Sucursal')")
