...
public class ServicioDaoImpl implements ServicioDao {
	...
	public void create(Servicios servicios) {
		sessionFactory.getCurrentSession().persist(servicios);
	}
	...
	public List<Servicios> findAll() {
		return sessionFactory.getCurrentSession().createQuery("from Servicios s order by s.id asc", Servicios.class)
				.getResultList();
	}
	...
	public Paginacion<Servicios> getServiciosPaginado(int numeroPagina, int tamanhoPagina) {
		...
		totalRegistros = sessionFactory.getCurrentSession()
				.createQuery("SELECT COUNT(s.id) from Servicios s", Long.class).getSingleResult();
		...
		TypedQuery<Servicios> query = sessionFactory.getCurrentSession()
				.createQuery("from Servicios s order by s.id asc", Servicios.class);
	...
	public void delete(int id) {
		sessionFactory.getCurrentSession().remove(sessionFactory.getCurrentSession().get(Servicios.class, id));
	}
