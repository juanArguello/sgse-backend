...
public class UsuarioDaoImpl implements UsuarioDao {
	...
	public Usuario findByUsername(String username) {
		return this.sessionFactory.getCurrentSession()
				...
				.setParameter("username", username).setReadOnly(true).uniqueResult();
	}

	@Override
	public Usuario findByEmail(String correo) {
		return (Usuario) this.sessionFactory.getCurrentSession()
				.createQuery("from Usuario u where u.email = :email", Usuario.class).setParameter("email", correo)
				.getSingleResult();
	}

	@Override
	public List<Usuario> findAll() {
		return this.sessionFactory.getCurrentSession().createQuery("from Usuario u order by u.id asc", Usuario.class)
				.getResultList();
	}
	...
	public Paginacion<Usuario> getUsuariosPaginado(int numeroPagina, int tamanhoPagina) {
		...
		Long totalRegistros;
		totalRegistros = sessionFactory.getCurrentSession().createQuery("SELECT COUNT(u.id) from Usuario u", Long.class)
				.getSingleResult();
...
//        query.executeUpdate();
		this.sessionFactory.getCurrentSession().remove(this.sessionFactory.getCurrentSession().get(Usuario.class, id));
	}

	@Override
	public int cantidadFilas() {
		return this.sessionFactory.getCurrentSession().createQuery("select count(*) from Usuario u", Long.class)
