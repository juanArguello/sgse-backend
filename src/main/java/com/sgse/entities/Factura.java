...
public class Factura implements Serializable {
	...
	public Factura(Integer id, String nombreEmisor, int nroFactura, int nroTimbrado, String nombreCliente,
			String tipoPago, String rucCiCliente, int precioUnitario, int valorIva, int cantidad, int costoTotal) {
		this.id = id;
